...
class HannichidataList {
  List<Hannichidata> hannichidata = [
   ...
   const Hannichidata(time: '午前', title: '数学グラフ描写アプリ「Desmos」を使ってアートゲームを作ろう', place: '化学講義室'),
   ...
   const Hannichidata(time: '午前', title: 'ビーズストラップでＴ２ファージやDNAを作ろう！！ ', place: '生物実験室'),
   const Hannichidata(time: '午後', title: '麻雀大会', place: '多目的３'),
   const Hannichidata(time: '午後', title: '数学グラフ描写アプリ「Desmos」を使ってアートゲームを作ろう', place: '化学講義室'),
   const Hannichidata(time: '午後', title: '向陽クイズ王決定戦', place: '多目的４'),
   const Hannichidata(time: '午後', title: '解の公式及び階乗の分かりやすい解説講座 ', place: '多目的２'),
   const Hannichidata(time: '午後', title: '科学部の水ロケット講座', place: '生物実験室からグラウンド '),
