...
class HakurankaidataList {
  List<Hakurankaidata> hakurankaidata = [
   ...
   const Hakurankaidata(title: 'お空の彼方へさぁ行くぞ！', place: '中棟3階104教室', detail: '「陸地から空への大冒険」がテーマです！陸地では、縁日の定番である輪投げ、射的やボール落としが体験できます。陸地でのミッションを達成すると、気球で空へ冒険に行くことができます！', classname: '104'),
   ...
   const Hakurankaidata(title: 'VS山嵐', place: '中棟2階202教室', detail: 'あの人気アイドルグループのバラエティ番組が202に帰ってくる！？お馴染みのあのゲームが君を待っている！さあ、君もテレビの世界に飛び込んで体験してみよう！', classname: '202'),
   ...
   const Hakurankaidata(title: '絶望の放課後', place: '中棟2階204教室', detail: 'ふとした好奇心で放課後集まって肝試しをすることになった生徒4人。楽しい夏の思い出になるはずだったのに夜の学校には誰かいてー204の新感覚ホラー映画\nあなたは耐えられるか？', classname: '204'),
