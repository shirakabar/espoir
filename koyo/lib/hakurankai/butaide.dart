...
@override
 ...
 return Scaffold(body: 
      Column(
        ...
        const Center(child:
        Text('発表一覧',style: TextStyle(fontWeight: FontWeight.w700,fontSize: 20),), 
        ),
        const SizedBox(
          height: 10,
        ),
        Expanded(child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            borderRadius: BorderRadius.circular(10)
              ...
              child: ListTile(
                leading: Text(_ichirandata[index].classname,style: const TextStyle(fontSize: 24,fontWeight: FontWeight.w400),),
                title: Text(
                ...
                Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => KyoDe(title: _ichirandata[index].title, place: '体育館', detail: _ichirandata[index].detail, classname: _ichirandata[index].classname)),
                          );
                },
        ...
        Expanded(child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            borderRadius: BorderRadius.circular(10)
              ...
              child: ListTile(
                leading: Text(_firstdata[index].time,style: const TextStyle(fontSize: 24,fontWeight: FontWeight.w400),),
                title: Text(
                ...
                Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => KyoDe(title: _firstdata[index].title, place: '体育館', detail: _firstdata[index].detail, classname: _firstdata[index].classname)),
                          );
                },
                 shape: const RoundedRectangleBorder(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
        ...
        Expanded(child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            borderRadius: BorderRadius.circular(10)
              ...
              child: ListTile(
                leading: Text(_seconddata[index].time,style: const TextStyle(fontSize: 24,fontWeight: FontWeight.w400),),
                title: Text(
                ...
                Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => KyoDe(title: _seconddata[index].title, place: '体育館', detail: _seconddata[index].detail, classname: _seconddata[index].classname)),
                          );
                },
                 shape: const RoundedRectangleBorder(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
