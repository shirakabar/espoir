                        ...
                        return Expanded(
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  final int hourcom = int.parse(hour[index]
                                      .replaceAll(':', "")); //整理券の時間hhmmの整数
                                  final int halfcom = int.parse(
                                      half[index].replaceAll(':', ""));
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: OutlinedButton(
                                            onPressed: data?[hour[index]] < 1 ||
                                                    hourcom <= nowcom
                                                ? null
                                                : () => onTapped(
                                                    hour[index],
                                                    half[
                                                        index]), //三項演算子をつかうらしい ||はOR
