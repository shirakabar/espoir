...
import 'package:koyo/ticket/ticket.dart';
import 'package:koyo/ticket/ticketoverlay.dart';
                ...
                children: [
                  MobileScanner(
                      ...
                      onDetect: (capture) async {
                        ...
                        var randomCode = await FirebaseFirestore.instance
                            .collection('Ticket')
                            .doc('randomCode')
                            .get();
                        final classname = value!.substring(16);
                        //firestore内のパスワードと一致していて、クラス名が存在したら
                        if (value.startsWith(randomCode['code'].toString()) &&
