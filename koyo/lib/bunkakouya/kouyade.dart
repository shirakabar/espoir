                ...
                itemBuilder: (BuildContext context, int index) {
                  return Padding(
                      ...
                      child: Card(
                          ...
                          child: ListTile(
                            leading: Text(
                              _gymdata[index].number,
                              style: const TextStyle(
                                  fontSize: 25, fontWeight: FontWeight.w400),
                            ),
                            title: Text(
                              _gymdata[index].title,
                            ...
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => Bunkoushowde(
                                          title: _gymdata[index].title,
                                          place: '体育館',
                                          detail: _gymdata[index].detail,
                                          number: _gymdata[index].number)));
                            }, 
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Padding(
                      ...
                      child: Card(
                          ...
                          child: ListTile(
                            leading: Text(
                              _grounddata[index].number,
                              style: const TextStyle(
                                  fontSize: 25, fontWeight: FontWeight.w400),
                            ),
                            title: Text(
                              _grounddata[index].title,
                              style: const TextStyle(fontSize: 20),
                            ),
                            tileColor: const Color.fromARGB(255, 241, 249, 255),
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => Bunkoushowde(
                                          title: _grounddata[index].title,
                                          place: 'グラウンド',
                                          detail: _grounddata[index].detail,
                                          number: _grounddata[index].number)));
                            }, 
                            shape: const RoundedRectangleBorder(
                              borderRadius:
                                  BorderRadius.all(Radius.circular(10)),
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Padding(
                      ...
                      child: Card(
                          ...
                          child: ListTile(
                            leading: Text(
                              _ondemanddata[index].number,
                              style: const TextStyle(
                                  fontSize: 25, fontWeight: FontWeight.w400),
                            ),
                            title: Text(
                              _ondemanddata[index].title,
                              style: const TextStyle(fontSize: 20),
                            ),
                            tileColor: const Color.fromARGB(255, 241, 249, 255),
                            onTap: () {
